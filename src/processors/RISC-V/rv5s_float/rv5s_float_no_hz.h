...
class RV5S_FLOAT_NO_HZ : public RipesVSRTLProcessor {
...
public:
  ...
  RV5S_FLOAT_NO_HZ(const ExtensionSetInfo &extensions)
      : RipesVSRTLProcessor(
            "5-Stage floating point RISC-V Processor with forwarding but "
