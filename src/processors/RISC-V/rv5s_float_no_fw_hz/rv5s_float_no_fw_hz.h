...
#include "rv5s_float_no_fw_hz_exmem.h"
#include "rv5s_float_no_fw_hz_idex.h"
#include "rv5s_float_no_fw_hz_memwb.h"
...
class RV5S_FLOAT_NO_FW_HZ : public RipesVSRTLProcessor {
...
public:
  ...
  SUBCOMPONENT(idex_reg, TYPE(IDEX_F<XLEN>));
  SUBCOMPONENT(exmem_reg, TYPE(EXMEM_F<XLEN>));
  SUBCOMPONENT(memwb_reg, TYPE(MEMWB_F<XLEN>));
